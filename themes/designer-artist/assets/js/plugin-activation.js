jQuery(document).ready(function($) {
    'use strict';
    var this_obj = designer_artist_plugin_activate_plugin;
    ...
    $(document).on('click', '.designer-artist-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message designer-artist-plugin-install');
                button.addClass('button-primary designer-artist-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.designer-artist-recommended-plugins .designer-artist-activation-note').css('display','block');
    ...
    $(document).on('click', '.designer-artist-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .designer-artist-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .designer-artist-recommended-plugins').css('display','none');
    });
