...
class Designer_Artist_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'designer-artist' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $designer_artist_font_awesome_icon_array = designer_artist_font_awesome_icon_array();
                foreach ($designer_artist_font_awesome_icon_array as $designer_artist_font_awesome_icon) {
                        $icon_class = $this->value() == $designer_artist_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($designer_artist_font_awesome_icon).'"></i>
                        <span class="designer-artist-social-class">'.esc_attr($designer_artist_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function designer_artist_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'designer-artist-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'designer_artist_customizer_script' );

if(!function_exists('designer_artist_font_awesome_icon_array')){
    function designer_artist_font_awesome_icon_array(){
